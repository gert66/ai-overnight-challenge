(function () {
  ...
  function showBanner() {
    ...
    box.innerHTML = isEnglish
      ? '<strong>Privacy-friendly analytics</strong><span>We use Google Analytics to understand which pages are visited and improve the AI Challenge. Advertising tracking is disabled.</span><div class="actions"><button class="accept" type="button">Allow analytics</button><button class="decline" type="button">No thanks</button></div>'
      : '<strong>Privacyvriendelijke analytics</strong><span>We gebruiken Google Analytics om te zien welke pagina’s worden bezocht en de AI Challenge te verbeteren. Advertentietracking staat uit.</span><div class="actions"><button class="accept" type="button">Analytics toestaan</button><button class="decline" type="button">Nee bedankt</button></div>';
